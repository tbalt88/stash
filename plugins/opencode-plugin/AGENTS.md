...
Your activity in this repo is streamed to your Stash, so your agents and other tools can see what you're working on.
...
- `stash vfs "find /me -name '*.md'"` — shared pages
