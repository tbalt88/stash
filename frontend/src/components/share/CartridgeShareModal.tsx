...
export default function CartridgeShareModal() {
  ...
  const [workspacePermission, setWorkspacePermission] =
    useState<CartridgeGeneralPermission>("read");
  const [publicPermission, setPublicPermission] =
    useState<CartridgeGeneralPermission>("none");
        ...
        <div className="mb-2 grid grid-cols-1 gap-3 text-[12px] sm:grid-cols-2">
          ...
          <div className="flex flex-col gap-1">
            ...
            <CustomSelect
              ...
              onChange={(next) => setVisibility(next as CartridgeVisibility)}
...
function buildInitialSelection(
  initial: CartridgeItemSpec[] | undefined,
...
function isSelectableRowType(
  objectType: CartridgeItemSpec["object_type"]
...
function modalTitle(initial: CartridgeItemSpec[] | undefined, workspaceName: string | undefined) {
