...
def upgrade() -> None:
    ...
    op.execute("ALTER TABLE cartridges RENAME COLUMN forked_from_stash_id TO forked_from_cartridge_id")
...
def downgrade() -> None:
    ...
    op.execute("ALTER TABLE cartridges RENAME COLUMN forked_from_cartridge_id TO forked_from_stash_id")
